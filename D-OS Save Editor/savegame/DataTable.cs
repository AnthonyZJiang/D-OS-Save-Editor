...
namespace D_OS_Save_Editor
{
    public class DataTable
    {
        ...
        /// <summary>
        /// 3 lines for one Ability
        ///  - Ability enum member name
        ///  - Ability name like in game
        ///  - Ability effect like in game
        /// </summary>
        public static string[] AbilitiesNamesEffects =
        {
            "Bow",
            "Bow",
            "Bow increases the damage you do using bows.",
            "Crossbow",
            "Crossbow",
            "Crossbow increases the critical chance and the critical damage you do using crossbows.",
            "DualWielding",
            "Dual Wielding",
            "Dual Wielding reduces damage penalty and total Action Point cost when wielding two weapons.",
            "SingleHanded",
            "Single-Handed",
            "Single-Handed increases damage when using a single-handed weapon (dagger, sword, axe, or mace). This damage bonus is not applied when dual wielding.",
            "Tenebrium",
            "Tenebrium",
            "Tenebrium allows you to equip more powerful Tenebrium weapons.",
            "TwoHanded",
            "Two-Handed",
            "Two-Handed increases critical chance and critical multiplier when using a two-handed weapon (sword, axe, spear or staff).",
            "Wand",
            "Wand",
            "Wand increases damage of main hand wand attacks.",
            "ArmourSpecialist",
            "Armour Specialist",
            "Armour Specialist improves your armour rating and decreases your heavy armour movement penalty.",
            "BodyBuilding",
            "Body Building",
            "Body Building improves your saving throws against Knocked Down, Burning, Frozen, Bleeding, Crippled, Blinded, Weak, Diseased, Infected, and Drunk.",
            "ShieldSpecialist",
            "Shield Specialist",
            "Shield Specialist increases chance of blocking when using shields.",
            "Willpower",
            "Willpower",
            "Willpower improves your saving throws against Feared, Mute, Charmed, Stunned, Cursed, Slowed, Petrified, Decaying Touch, Mark of Death, Remorse, and Shackles of Pain.",
            "Aerotheurge",
            "Aerotheurge",
            "Determines how many Aerotheurge spells you can learn and how many Action Points it costs to use higher level Aerotheurge spells.",
            "ExpertMarksman",
            "Expert Marksman",
            "Determines how many Expert Marksman skills you can learn and how many Action Points it costs to use higher level Expert Marksman skills.",
            "Geomancer",
            "Geomancer",
            "Determines how many Geomancer spells you can learn and how many Action Points it costs to use higher level Geomancer spells.",
            "Hydrosophist",
            "Hydrosophist",
            "Determines how many Hydrosophist spells you can learn and how many Action Points it costs to use higher level Hydrosophist spells.",
            "ManAtArms",
            "Man-At-Arms",
            "Determines how many Man-At-Arms skills you can learn and how many Action Points it costs to use higher level Man-At-Arms skills.",
            "Pyrokinetic",
            "Pyrokinetic",
            "Determines how many Pyrokinetic spells you can learn and how many Action Points it costs to use higher level Pyrokinetic spells.",
            "Scoundrel",
            "Scoundrel",
            "Determines how many Scoundrel skills you can learn and how many Action Points it costs to use higher level Scoundrel skills.",
            "Witchcraft",
            "Witchcraft",
            "Determines how many Witchcraft spells you can learn and how many Action Points it costs to use higher level Witchcraft spells.",
            "Bartering",
            "Bartering",
            ...
            "Blacksmithing",
            "Blacksmithing",
            "Blacksmithing allows you to repair your own items; the more you invest, the faster you'll work. Required to create and improve metal-enhanced weapons and armour.",
            "Crafting",
            "Crafting",
            ...
            "Telekinesis",
            "Telekinesis",
            "With Telekinesis you can move items from a distance. The higher your [1] score, the heavier the items you can telepathically lift, and the farther you can move them.",
            "Lockpicking",
            "Lockpicking",
