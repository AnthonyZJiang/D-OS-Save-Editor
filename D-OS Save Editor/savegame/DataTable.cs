...
namespace D_OS_Save_Editor
{
    public class DataTable
    {
        ...
        public static string[] TalentNamesEffects =
        {
            ...
            "Eagle Eyes",
            "Eagle Eyes improves the impact of Perception on your line of sight by 50%.",
            "Braveheart",
            "Braveheart increases your ability to resist fear by 50%.",
            "Stand Your Ground 2",
            "Stand Your Ground increases your ability to resist knockdown attacks by 50%.",
            "Lightning Rod 2",
            ...
            "Silver-tongued",
            "Silver-tongued increases your ability to resist being silenced by 50%. (When silenced you can no longer cast spells until the effect wears off.)",
            "Comeback Kid",
            ...
            "Glass Cannon",
            "Glass Cannon doubles your recovery AP, but your total vitality is decreased by 50% (including the bonus from Lone Wolf).",
            "Know-it-All",
            ...
            "Demon",
            "A character with Demon has a chance to burn an opponent who strikes with a melee weapon, but takes a 25% penalty to Water Resistance.",
            "Ice King",
            "A character with Ice King has a chance to chill an opponent who strikes with a melee weapon, but takes a 25% penalty to Fire Resistance.",
            "Courageous",
            "Courageous grants you immunity to Fear, but you can no longer flee from combat.",
            "Voluble Mage",
            "Voluble Mage grants you immunity to Silence.",
            "Walk it Off",
            ...
            "Thick Skin",
            "Thick Skin gives you 5 extra base armour + Man-at-Arms x 2.",
            "Picture of Health",
            "Picture of Health gives you 5% x Man-at-Arms extra Vitality.",
            "Weather the Storm",
            "Weather the Storm gives you 5% x Man-at-Arms extra Magic Resistance.",
            "Arrow Recovery",
            ...
            "Quickdraw",
            "Quickdraw reduces 1AP from the cost of using ranged weapons.",
            "Mack the Knife",
            "Mack the Knife reduces 1AP from the cost of using daggers and knives.",
            "Back-Stabber",
            "Back-Stabber allows a character to backstab with daggers and knives.",
            "Swift Footed",
            "Swift Footed gives you a 20% movement bonus.",
            "Headstrong",
            "Headstrong gives you 20% extra damage against opponents that are slowed, crippled or knocked down.",
            "Avoid Opportunists",
            "Gives you the ability to evade attacks of opportunity.",
            "Slongshot",
            "Adds a 5 meter distance to your grenade throws.",
            "Pinpoint",
            "Your grenade throws will never miss again.",
            "Magician",
            "Gives your one extra use of a wand skill.",
            "Parry Master",
            "Grants 10% Blocking Chance while dual wielding."
        };
